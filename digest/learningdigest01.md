# 01-RUST Virtual Machine Learning

## 今日学习总结

> 当前北京时间：2024 年 09 月 11 日 16:14:33

### 进度

- [x] build_vm_part_06.md
- [x] build_vm_part_07.md
- [x] build_vm_part_08.md
- [x] build_vm_part_09.md
...
- 更快的编译链接：`LLVM + LLD`, 从而提升编译速度，加快编码循环
  ...
  - 使用方式：在项目目录下，新建一个 `.cargo/config.toml` 文件，内容如下：`[target.x86_64-unknown-linux-gnu]
rustflags = ["-C", "linker=clang", "-C", "link-arg=-fuse-ld=ll]`
...
1. [Nom](https://github.com/rust-bakery/nom) 的各个功能作用以及使用：alt, map, map_res,terminated,tuple,context,multispace?,line_ending,alpha?,digit?,eof, preceded,tag,IResult...

[Nom book for freshers](https://github.com/tfpk/nom/blob/tfpk/nom-guide/doc/nom-guide/src/SUMMARY.md)
